	...
	<body>
		...
		<!-- Insert request in function of data sent by the chosecapteur.php form + "dynamic" displaying of sensor's data-->
			<?php
				...
				$request = "INSERT INTO `Capteur` (`name`,`type`,`bat`)
				VALUES('$name','$type','$bat')";
				...
				echo "<ul>
						...
						<li> Type de capteur : $type </li>
						<li> Batiment auquel le capteur appartient : $bat </li>
					  </ul>
					 </div>";
			?>
		</section>
